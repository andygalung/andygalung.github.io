...
<div class="conHomeFront <?php if(($_GET['harusLogin']??'') == 'yes') echo 'defaultAfterAnimateHide'; ?>">
	<div class="homeFront homeFrontWhite" id="text-align-center">
		...
		<img class="marginBottom20px" src="<?= config::base_url('assets/img/icon/manport.png'); ?>" alt="Logo Unimed">
	...
	<p class="copyRight marginTop20px">Copyright &copy; <?= date('Y'); ?> Unimed. All Rights Reserved</p>
</div>
...
<div class="loginGuru <?php if(($_GET['harusLogin']??'') == 'yes') echo 'defaultAfterAnimateShow display_block'; ?>">
	<form id="form" method="post">
		...
		<p class="copyRight marginTop20px">Copyright &copy; <?= date('Y'); ?> . All Rights Reserved</p>
	</form>
</div>
<?php endif; ?>
